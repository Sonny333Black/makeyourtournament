...
namespace makeyourtournament.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            String key = Request.Form["freundesschluessel"];
            String username = User.Identity.Name;
            var user = db.UserSet.Where(i => i.name == username).First();

            logic.newFriend(user,key);                 
        ...
        public ActionResult deleteFriend()
        {
            ...
            int friend_id = Int32.Parse(Request.Form["friend_id"]);

            logic.deleteFriend(user, friend_id);           
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteAccountNow()
        {
            var AutheticationManager = HttpContext.GetOwinContext().Authentication;
            AuthenticationManager.SignOut();
            var user = UserManager.FindById(User.Identity.GetUserId());
            UserManager.DeleteAsync(user);
            var userDAL = db.UserSet.Where(i => i.name == user.UserName).First();
            logic.deleteUser(userDAL);
            return Redirect("/");
        }
